...
- RF performs better than LR when there are correlations between features (multicollinearity) or when there is a non-linear relationship with the response and the odds
